...
# ── Intro: Story section ───────────────────────────────────────────
with st.expander("ℹ️  What is this tool and who is it for?", expanded=False):
    ...
    # Methodology note
    st.markdown("""
    <div class="methodology-note" style="margin-top: 1.2rem;">
        <strong>Why this calculation matters for your disclosure</strong><br>
